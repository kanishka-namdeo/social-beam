...
export function FacebookPreview({ content, account }: FacebookPreviewProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between p-4 pb-2">
        ...
        <button type="button" className="rounded-full p-1.5 text-muted-foreground hover:bg-muted transition-colors" aria-label="More options">
      ...
      <div className="flex items-center justify-between px-4 py-2 text-xs text-muted-foreground">
        <div className="flex items-center gap-1.5">
          <div className="flex -space-x-1">
            ...
            <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-yellow-400 text-[10px]">
              ❤️
            </span>
          </div>
          <span>57</span>
      ...
      <div className="flex items-center justify-around px-4 py-1">
        <button
          type="button"
          className="flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-semibold text-muted-foreground hover:bg-muted transition-colors"
        >
