  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-sm border bg-card p-4">
        <h3 className="text-base font-medium tracking-tight text-foreground mb-3">Get started in 3 steps</h3>
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-primary text-primary-foreground text-xs font-semibold shrink-0">1</div>
            <div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-primary text-primary-foreground text-xs font-semibold shrink-0">2</div>
            <div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-primary text-primary-foreground text-xs font-semibold shrink-0">3</div>
            <div>
